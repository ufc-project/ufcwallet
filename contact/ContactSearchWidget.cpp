...
void ContactSearchWidget::InitStyle()
{
    ...
    QPalette palette;
    palette.setColor(QPalette::Window, QColor(19,32,80));
    setPalette(palette);


    setStyleSheet("QPushButton{ background:transparent;}"
                  "QLineEdit{background-color:transparent;font-size:11px;border:none;border-radius:0px;color:white;border-bottom:1px solid rgb(105,124,255);}"
                  );
