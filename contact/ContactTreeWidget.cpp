...
void ContactTreeWidget::initTreeStyle()
{
    ...
    setStyleSheet("QWidget{border:none;}"
                  ...
                  "QTreeView{background:rgb(19,32,80);border:none;padding-left:0px;\
                      color:rgb(104,86,144);font:65 12px \"Microsoft YaHei UI\";outline:0px;margin-left:5px;}"
        ...
        "QTreeView::branch::hover::adjoins-item,QTreeView::branch::hover::!adjoins-item,QTreeView::item::hover{background:rgb(19,32,80);}"
