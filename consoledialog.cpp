...
//    setParent(HXChain::getInstance()->mainFrame);
    ...
    ui->containerWidget->setStyleSheet("#containerwidget{background-color:rgb(240,240,240);border-radius:4px;}QLabel{color:rgb(51,51,51);}");

    ui->closeBtn->setStyleSheet(CLOSEBTN_STYLE);
    ui->clearBtn->setStyleSheet(CANCELBTN_STYLE);
    ui->consoleLineEdit->setStyleSheet("QLineEdit{color:rgb(19,32,80);font-size:12px;}");
