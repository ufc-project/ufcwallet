...
void FirstLogin::InitStyle()
{
    ...
    QPalette palette;
    palette.setBrush(QPalette::Window,  QBrush(QPixmap(":/ui/wallet_ui/cover.jpg").scaled(this->size())));
    setPalette(palette);
    ...
    ui->pwdLineEdit->setStyleSheet("QLineEdit{max-height:32px;background: transparent;color: rgb(255,255,255);font: 12px \"Microsoft YaHei UI Light\";border:none;border-radius:0px;border-bottom:1px solid rgb(255,255,255);padding: 0px 10px 0px 6px;}"
                                   "QLineEdit:disabled{color: rgb(151,151,151);}");
    ui->pwdLineEdit2->setStyleSheet("QLineEdit{max-height:32px;background: transparent;color: rgb(255,255,255);font: 12px \"Microsoft YaHei UI Light\";border:none;border-radius:0px;border-bottom:1px solid rgb(255,255,255);padding: 0px 10px 0px 6px;}"
                                    "QLineEdit:disabled{color: rgb(151,151,151);}");
