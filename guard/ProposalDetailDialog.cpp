...
void ProposalDetailDialog::setProposal(QString _proposalId)
{
    ...
    {
        ui->typeLabel->setText(tr("create director"));
    ...
    {
        ui->typeLabel->setText(tr("resign director"));
    ...
    {
        ui->typeLabel->setText(tr("change permanent director"));
    ...
    {
        ui->typeLabel->setText(tr("set locked balance of director"));
    ...
    {
        ui->typeLabel->setText(tr("senator vote for changing director"));
