...
void SenatorChangeSenatorDialog::ChangeSenatorSlots()
{
    ...
    connect(wi,&PasswordConfirmWidget::confirmSignal,[this,proposingAccount,expiration_time,replaceArr](){
        HXChain::getInstance()->postRPC("id+update_guard_formal",toJsonFormat("update_validator_formal",
...
void SenatorChangeSenatorDialog::jsonDataUpdated(QString id)
{
    if("id+update_guard_formal" == id)
    {
        ...
        if( result.startsWith("\"result\":{"))             // 成功
        {
            ...
            transactionResultDialog.setInfoText(tr("Transaction of changing directors has been sent,please wait for confirmation"));
