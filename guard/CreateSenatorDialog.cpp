...
void CreateSenatorDialog::jsonDataUpdated(QString id)
{
    if("id-create_guard_member" == id)
    {
        ...
        if( result.startsWith("\"result\":{"))             // 成功
        {
            ...
            transactionResultDialog.setInfoText(tr("Transaction of create director has been sent,please wait for confirmation"));
...
void CreateSenatorDialog::CreateSenatorSlots()
{
    ...
    connect(wi,&PasswordConfirmWidget::confirmSignal,[this](){
        ...
        HXChain::getInstance()->postRPC("id-create_guard_member",toJsonFormat("create_validator_member",
