...
void NormalLogin::InitStyle()
{
    ...
    ui->pwdLineEdit->setStyleSheet("QLineEdit{max-height:32px;background: transparent;color: rgb(255,255,255);font: 10px \"Microsoft YaHei UI Light\";border:none;border-radius:0px;border-bottom:1px solid rgb(255,255,255);padding: 0px 10px 0px 6px;}"
