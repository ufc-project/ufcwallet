...
//#define TEST_WALLET
#define ASSET_NAME "UFC"
#define ACCOUNT_ADDRESS_PREFIX  ASSET_NAME"N"
#define CONTRACT_ADDRESS_PREFIX ASSET_NAME"C"
#define MULTISIG_ADDRESS_PREFIX ASSET_NAME"M"
#define PUBKEY_PREFIX ASSET_NAME
...
#else
#define LOCKFUND_CONTRACT_ADDRESS  ""
#define EXCHANGE_MODE_CONTRACT_ADDRESS  ""  // 交易所模式合约地址
#endif

#ifdef TEST_WALLET
#define MIDDLE_DEFAULT_URL      ""
...
#ifdef TEST_WALLET
#define NODE_RPC_PORT   50613
#define CLIENT_RPC_PORT 50614
#else
#define NODE_RPC_PORT   50603
#define CLIENT_RPC_PORT 50605
#endif
...
//    void fetchFormalGuards();
    ...
    QString accountIdToName(QString accountId);      // 查询所有已知的accountId
