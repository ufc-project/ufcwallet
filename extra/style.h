...
#define OKBTN_STYLE     "QToolButton{font: 11px \"微软雅黑\";background-color: rgb(23,176,235);border:0px solid white;border-radius:3px;color: white;}"  \
                        "QToolButton:pressed{background-color:rgb(23,176,235);}"\
                        "QToolButton:disabled{background-color:rgb(196,191,214);}"

#define CANCELBTN_STYLE "QToolButton{font: 11px \"微软雅黑\";background:rgb(255,255,255);color: rgb(23,176,235);border:1px solid rgb(23,176,235);border-radius:3px;}"  \
                        "QToolButton:pressed{background-color:rgb(255,255,255);color: rgb(23,176,235)}"\
                        "QToolButton:disabled{color:rgb(196,191,214);}"
...
#define CONTAINERWIDGET_STYLE   "#containerwidget{background-color:rgb(255,255,255);border-radius:4px;}"  \
                                "QLabel{color:rgb(51,51,51);}"

#define TOOLBUTTON_STYLE_1      "QToolButton{font: 11px \"微软雅黑\";background-color:transparent; border:1px solid rgb(19,32,80);border-radius:9px;color: rgb(19,32,80);}" \
...
#define PUSHBUTTON_CHECK_STYLE  "QPushButton{font:11px \"微软雅黑\";background:transparent;border:none;color: rgb(137,129,161);}" \
                                "QPushButton::checked{color:rgb(19,32,80);border-bottom:2px solid rgb(19,32,80);}"

#define TABLEWIDGET_STYLE_1     "QTableView{background-color:rgb(255,255,255);border:none;border-radius:5px;font: 11px \"Microsoft YaHei UI Light\";color:rgb(19,32,80);}" \
                                "QHeaderView{border:none;border-bottom:1px solid rgb(222,218,236);border-top-left-radius:5px;border-top-right-radius:5px;background-color:rgb(255,255,255);color:rgb(137,129,161);font: bold 11px \"Microsoft YaHei UI Light\";}" \
                                "QHeaderView:section{height:30px;border:none;background-color:rgb(255,255,255);}" \
...
#define TEXTBROWSER_READONLY    "QTextBrowser{color:rgb(19,32,80);border:none;border-radius:10px;outline:1px solid rgb(196,191,214);outline-radius:8px;}"
