    ...
    ui(new Ui::KLineWidget)
{
    ...
    setStyleSheet("QTableView{background-color:rgb(255,255,255);border:none;border-radius:0px;font: 11px \"微软雅黑\";color:rgb(19,32,80);}"
...
//                  "QComboBox QAbstractItemView{ color:rgb(83,61,138);selection-color: white;background-color: rgb(255,255,255);selection-background-color: rgb(164,77,179);}"
                  );
...
{
    ExchangePairSelectDialog dialog(ASSET_NAME);
    connect(&dialog, &ExchangePairSelectDialog::pairSelected, this, &KLineWidget::onPairSelected);
    connect(&dialog, &ExchangePairSelectDialog::pairSelected, this, &KLineWidget::pairChanged);
